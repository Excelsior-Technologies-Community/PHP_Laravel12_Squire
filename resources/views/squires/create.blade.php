...
@section('title', 'Assign New Squire')
    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header">
                <h3>Assign New Squire</h3>
            </div>
            <div class="card-body">
                <form action="{{ route('squires.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('age') is-invalid @enderror" 
                               id="age" name="age" value="{{ old('age') }}" min="10" max="30" required>
                        @error('age')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('knight_id') is-invalid @enderror" 
                            ...
                            @foreach($knights as $knight)
                                <option value="{{ $knight->id }}" {{ old('knight_id') == $knight->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        <button type="submit" class="btn btn-primary">Assign Squire</button>
